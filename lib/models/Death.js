...
const deathSchema = new mongoose.Schema(
  {
    ...
    death: {
      ...
      date: {
        day: { type: Number }, // Опционално
        month: { type: Number }, // Опционално
        year: { type: Number, required: true }, // Само годината е задолжителна
    ...
    burial: {
      ...
      confessed: { type: String }, // Дали се исповедал "Да" или "Не"
    },
